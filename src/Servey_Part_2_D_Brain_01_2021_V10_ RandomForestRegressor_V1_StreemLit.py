...
file_path_in = "G:/Python_Scripts/Dimi_Data/"
file_path_out = "G:/Python_Scripts/Data_Result/"

file_name_in = "1_KA_14ch_LR_23_01_2020_VStim_20Repeat_3sec_epoch_3_off_0.25_chunk_0.25_4_with_shunk_and_notnull_scaler.csv"
#file_name_in = "2_KA_14ch_LR_23_01_2020_VStim_20Repeat_3sec_epoch_3_off_0.25_chunk_0.25_4_with_shunk_and_notnull_scaler.csv"
#file_name_in = "3_GD_14ch_LR_24_01_2020_VStim_20Repeat_3sec_epoch_3_off_0.25_chunk_0.25_4_with_shunk_and_notnull_scaler.csv"
#file_name_in = "4_GD_14ch_LR_24_01_2020_VStim_20Repeat_3sec_epoch_3_off_0.25_chunk_0.25_4_with_shunk_and_notnull_scaler.csv"
...
str_filename_Out = 'BCI_Classification_Rand_For_Reg_'

File_Out_Full = file_path_out + str_filename_Out + dt_string + '.txt'

File_Out_Full_csv = file_path_out + str_filename_Out + dt_string + '.csv'

start_time = time.time()

#%%
# Data_Result
f = open( File_Out_Full,"w")
f.write("\n")
f.close()


#%%
# Data result into CSV file
with open(File_Out_Full_csv, 'w') as csvfile:
    # fieldnames = ['first_name', 'last_name', 'Grade']
    fieldnames = ['Repeat_ID','Servey_name', 'Time_Exec', 'Train_score', 'Test_score','Type', 'precision', 'recall', 'f1-score', 'support',  'Electrodes', 'Events','Servey_time','test_size','F_Name']
...
#data_1 = pd.read_csv("/content/drive/MyDrive/Colab_Notebooks/Dimi_Data/1_KA_14ch_LR_23_01_2020_VStim_20Repeat_3sec_epoch_3_off_0.25_chunk_0.25_4_with_shunk_and_notnull.csv", header = 0)
# data_1 = pd.read_csv(io.StringIO(download.decode('utf-8')))
